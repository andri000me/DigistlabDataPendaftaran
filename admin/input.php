            ...
            <form action="input-aksi.php" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="pmelalui">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="editonly" value="<?php echo $_SESSION['username'] ?>" readonly autofocus>
                </div>
              </div>

              <div class="box-footer">
                <button onClick="javascript:return confirm('Apakah anda ingin input data ini?');" type="submit" class="btn btn-primary">Simpan</button>
